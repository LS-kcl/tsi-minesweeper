...
public class SquareTest {
    ...
    public void getVisibleReturnsFForFlagged() {
        square.toggleFlag();
        Assertions.assertEquals("F", square.getVisible(), "Visible must return F");
    }

    @Test
    public void getVisibleReturnsXIfNotRevealed() {
        Assertions.assertEquals("X", square.getVisible(), "Visible must return X");
    }
    ...
    public void getVisibleReturnsMinesAroundIfRevealed() {
        square.revealSquare();
        square.setMinesAround(3);
        Assertions.assertEquals("3", square.getVisible(), "Visible must return the number of mines around");
    }
    ...
    public void getDebuggingVisibleReturnsFForFlagged() {
        square.toggleFlag();
        Assertions.assertEquals("F", square.getDebuggingVisible(), "Debugging visible must return F");
    }

    @Test
    public void getDebuggingVisibleReturnsMForMineIfNotRevealed() {
        square.setMine(true);
        Assertions.assertEquals("M", square.getDebuggingVisible(), "Debugging visible must return M");
    }
    ...
    public void getDebuggingVisibleReturnsMinesAroundIfNotRevealed() {
        square.setMinesAround(3);
        Assertions.assertEquals("3", square.getDebuggingVisible(), "Debugging visible must return the number of mines around");
    }
